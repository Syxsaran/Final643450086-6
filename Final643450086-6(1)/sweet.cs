...
namespace Final643450086_6_1_
{
    public partial class sweet : Form
    {
        ...
        {
            if (comboBox1.Text == "ขนมปัง")
            {
                textBoxprice.Text = "30";
            }
            else if (comboBox1.Text == "แฮมเบอร์เกอร์")
            {
                textBoxprice.Text = "40";
            }
            else if (comboBox1.Text == "ฮอตด็อก")
            {
                textBoxprice.Text = "50";
            }
            else if (comboBox1.Text == "แซนวิช")
            {
                textBoxprice.Text = "40";
            }
            else if (comboBox1.Text == "มาม่า")
            {
                textBoxprice.Text = "40";
            }
        }
